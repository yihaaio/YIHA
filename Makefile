...
pkgdatadir = $(datadir)/yihaatech
pkgincludedir = $(includedir)/yihaatech
pkglibdir = $(libdir)/yihaatech
pkglibexecdir = $(libexecdir)/yihaatech
...
ACLOCAL = ${SHELL} /root/YIHA/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /root/YIHA/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/YIHA/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/YIHA/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = yihaatech-cli
BITCOIN_DAEMON_NAME = yihaatechd
BITCOIN_GUI_NAME = yihaatech-qt
BITCOIN_TX_NAME = yihaatech-tx
...
COPYRIGHT_HOLDERS_FINAL = The YihaaTech Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = YihaaTech Core
COPYRIGHT_YEAR = 2017
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /root/YIHA/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = yihaatech
PACKAGE_BUGREPORT = https://github.com/yihaatech-project/yihaatech/issues
PACKAGE_NAME = YihaaTech Core
PACKAGE_STRING = YihaaTech Core 0.14.2
PACKAGE_TARNAME = yihaatech
PACKAGE_URL = https://yihaatech.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /root/YIHA
abs_srcdir = /root/YIHA
abs_top_builddir = /root/YIHA
abs_top_srcdir = /root/YIHA
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/YIHA/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/YihaaTech-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/YihaaTech-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/YihaaTech-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/YihaaTech-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
