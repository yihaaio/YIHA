...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The YihaaTech Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "YihaaTech Core"
...
#define PACKAGE_BUGREPORT "https://github.com/yihaatech-project/yihaatech/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "YihaaTech Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "YihaaTech Core 0.14.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "yihaatech"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://yihaatech.org/"
