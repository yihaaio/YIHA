...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s yihaatech-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  yihaatech-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded yihaatech transaction") + "\n" +
              "  yihaatech-tx [options] -create [commands]   " + _("Create hex-encoded yihaatech transaction") + "\n" +
              "\n";
