...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/yihaatech-project/yihaatech>";
    const std::string URL_WEBSITE = "<https://yihaatech.org>";
